...
const services = [
  {
    id: 1,
    name: 'Maggam Work',
    description: 'Traditional hand embroidery with intricate zardosi, kundan, and thread work. Perfect for bridal wear and special occasions.',
  ...
  },
  {
    ...
    description: 'Precision machine embroidery for consistent, detailed designs. Ideal for bulk orders and intricate patterns.',
    features: ['High Precision', 'Complex Patterns', 'Fast Turnaround', 'Bulk Orders'],
    price: 'Starting ₹1,000',
    image: 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=500&h=400&fit=crop',
  },
  {
    id: 3,
    name: 'Custom Blouse Design',
    description: 'Tailored blouse designs to complement your sarees. From simple cuts to elaborate designer pieces.',
    features: ['Perfect Fit', 'Designer Cuts', 'Matching Work', 'Quick Delivery'],
    price: 'Starting ₹1,500',
    image: 'https://images.unsplash.com/photo-1594463750939-ebb28c3f7f75?w=500&h=400&fit=crop',
  },
  {
    id: 4,
    name: 'Bridal Boutique Services',
    description: 'Complete bridal ensemble creation including lehenga customization, blouse design, and accessory matching.',
    features: ['Full Bridal Package', 'Lehenga Work', 'Accessory Matching', 'Trial Sessions'],
    price: 'Starting ₹15,000',
    image: 'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=500&h=400&fit=crop',
  },
]
